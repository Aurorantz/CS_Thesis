...
from .converter import convert_tf_dict_to_tuple
...
class RunDFA(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            dfa = DFA(
                data['states'], data['alphabet'], convert_tf_dict_to_tuple(data['transition_function']),
...
class RunNFA(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            result = nfa.run_with_input_list(request.data.get('input_list', []))
            return Response({"result": result})
        return Response(serializer.errors, status=400)    

class ConvertDFAToRG(APIView):
    def post(self, request, *args, **kwargs):
        serializer = DFASerializer(data=request.data)
        if serializer.is_valid():
            data = serializer.validated_data
...
class ConvertNFAEpsilonToRG(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            result = nfae.convert_to_RG()
            return Response({"result": result})
        return Response(serializer.errors, status=400)
class ConvertNFAToRG(APIView):
    def post(self, request, *args, **kwargs):
        serializer = NFASerializer(data=request.data)
        if serializer.is_valid():
            data = serializer.validated_data
...
class ConvertNFAEpsilonToDFA(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            dfa = nfa_epsilon.convert_to_DFA()._DFA__simplify()
            return Response(DFASerializer(dfa).data)
        return Response(serializer.errors, status=400)
...
class ConvertToRG(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            rg = dfa.__simplify().convert_to_RG()
